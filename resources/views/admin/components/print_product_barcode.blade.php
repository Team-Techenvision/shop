   ...
   <form class="w-75 m-auto">
        <div class="d-flex">
            <div class="form-group w-25 mr-3">
                ...
                <input type="text" class="form-control border border-info text-center" placeholder="1010000009" name="barcode_no" readonly>
            </div>
            <div class="form-group w-25 mr-3">
                <label for="print_no">Enter Number Print:</label>
                <input type="number" class="form-control border border-info text-center" value="1" min="1" name="print_no" required>
            </div>
            <div class="w-25 pt-4">        
