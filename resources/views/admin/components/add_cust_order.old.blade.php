            ...
            <tr valign="top" class="row addrows">                       
              ...
              <td class="col-sm-2">
                <div class="form-group">
                      ...
                      <input type="text" class="form-control text-center product_price" name="p_price[]"  value="" readonly>
                </div>
              </td>
              <td class="col-sm-1">                              
                <div class="form-group">
              ...
              <td class="col-sm-2">
                <div class="form-group">
                  ...
                  <input type="number" class="form-control text-center productqty" name="p_qty[]"  value="" min="1" required>
                </div>
              </td>
              <td class="col-sm-2">
                <div class="form-group">
