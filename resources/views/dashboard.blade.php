    ...
    <div class="row flex-grow">
      ...
      <div class="col-md-4 grid-margin stretch-card">
        <div class="card bg-success">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-baseline">
              <h6 class="card-title">Store Product</h6>            
            </div>
            <div class="row">
              <div class="col-12 col-md-12 text-center">
                <h3 class="">{{$Count_stock}}</h3>               
              </div>            
            </div>
          </div>
        </div>
      ...
      <div class="col-md-4 grid-margin stretch-card">
        <div class="card bg-warning">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-baseline">
              <h6 class="card-title">Product Expiry</h6>
              <small>1 Month</small>           
            </div>
            <div class="row">
              <div class="col-12 col-md-12 text-center">
                <h3 class="">{{$expiry_stock}}</h3>               
              </div>            
            </div>
          </div>
        </div>
    ...
    <div class="card overflow-hidden">
      <div class="card-body">
        ...
        <div class="flot-wrapper">
          ...
          <div class="row flex-grow">
          <div class="col-md-4 grid-margin stretch-card">
            <a href="{{url('view-Emplist')}}" class="w-100">
              <div class="card badge-danger-muted">
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-baseline">
      ...
      <div class="col-md-4 grid-margin stretch-card">
        <a href="{{url('avaliable-quantity')}}" class="w-100">
          <div class="card bg-primary">
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-baseline">
      ...
      <div class="col-md-4 grid-margin stretch-card">        
          <div class="card bg-success">
          <a href="{{url('daily-update')}}" class="w-100">
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-baseline">
                <h6 class="card-title">Daily Sell </h6>            
              </div>
              <div class="row">
                <div class="col-12 col-md-12 text-center">
      ...
      <div class="col-md-4 grid-margin stretch-card">
      <a href="{{url('top-sell-product')}}" class="w-100">
          <div class="card bg-info">
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-baseline">
                <h6 class="card-title">Top Selling Product</h6> 
                <small>1 Month Sell Quantity</small>                    
              </div>
              <div class="row">
                <div class="col-12 col-md-12 text-center">
      ...
      <div class="col-md-4 grid-margin stretch-card">
      <a href="{{url('product-exp-report')}}" class="w-100">
          <div class="card bg-warning">
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-baseline">
                <h6 class="card-title">Product Expiry</h6>
      ...
      <div class="col-md-4 grid-margin stretch-card">
        <a href="{{url('return_stock_report')}}" class="w-100">
          <div class="card bg-danger">
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-baseline">
                <h6 class="card-title">Return Stock</h6>                         
              </div>
              <div class="row">
                <div class="col-12 col-md-12 text-center">
